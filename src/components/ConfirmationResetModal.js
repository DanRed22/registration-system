    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center'>
      <div className='w-[50rem] rounded-xl flex justify-center items-center bg-white flex-col h-[20rem]'>
        ...
        <div>
            ...
            <input value={input} onChange={handleInputChange} type="text" id="input" class="bg-gray-50 border border-gray-300  text-sm rounded-lg  block w-full p-2.5  placeholder-gray-400 text-black " placeholder="reset" />
            <button onClick={handleClick} className='bg-red-700 p-2 hover:bg-red-900 text-white rounded-lg my-4'>Confirm</button>
        </div>
