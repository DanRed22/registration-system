            ...
            <div className="flex flex-row items-center my-4 border-white border-solid border-2 rounded-lg p-4 text-white">
                ...
                {sig && (
                    <>
                        ...
                        ></input>
                        <label for="show-sig" className="text-white mr-4">
                            {' '}
                            Show Signatures{' '}
                            <span className="text-[0.75rem] italic">{`(Uncheck this for CSV)`}</span>
                        </label>
                    </>
                )}
                ...
                ></input>
                <label for="show-prog" className="text-white mr-4">
                    {' '}
                    Course
                </label>
                ...
                ></input>
                <label for="show-add" className="text-white mr-4">
                    {' '}
                    Regular
                </label>
                ...
                ></input>
                <label for="sig" className="text-white mr-4">
                    Signatures
                </label>
                ...
                ></input>
                <label for="email" className="text-white mr-4">
                    Emails
                </label>
                ...
                ></input>
                <label for="truncTime" className="text-white mr-4">
                    Truncate Time
                </label>
                ...
                ></input>
                <label for="remarks" className="text-white mr-4">
                    Remarks
                </label>
                    ...
                    {showCoursesDropDown && (
                        <div class="z-0 absolute bg-white rounded-lg shadow w-44 dark:bg-gray-700">
                            <button
                                ...
                                className="text-black h-10 border rounded-lg w-full hover:bg-blue-200"
                            >
                                Select Course
                            </button>
                            <button
                                ...
                                className="text-black border h-10 rounded-lg w-full hover:bg-blue-200"
                            >
                                AMT
                            </button>
                            <button
