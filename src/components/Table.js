        ...
        <div className="w-[90%] flex flex-col items-center">
            ...
            <div className="flex justify-items-end items-center border border-white rounded-lg border-solid w-full my-4">
                ...
                <div class="m-2 flex justify-items-center items-center">
                    ...
                    <button
                        type="button"
                        className="mt-2 ml-4 p-2.5 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purle-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800"
                        onClick={() => {
                ...
                <div className="relative z-1">
                    <button
                        className="mt-2 ml-4 p-2.5 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 z-1"
                        onClick={() =>
